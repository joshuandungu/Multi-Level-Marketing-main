...
$sql="SELECT *FROM pinlist where userid='$_SESSION[userid]'and status='1'";
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-dark">Pin List(1250)</h1>
       ...
       $Tpin=$add['tpin'];
           if($Tpin!=""){
                    ...
                    echo " <td style='background-color:#333300' ><a class='text-light' href= 'transferpin.php?userid=$row[userid] & pin=$row[pin]'>Transfer</a></td>";
