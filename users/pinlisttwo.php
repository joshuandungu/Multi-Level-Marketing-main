...
$sql="SELECT *FROM pintwo where userid='$_SESSION[userid]' and status='1'";
      ...
      <?php  
       ...
       $Tpin=$add['tpin'];
           if($Tpin!=""){
                     ...
                     echo "<td style='background-color:#333300' ><a class='text-light' href= 'transferpintwo.php?userid=$row[userid] & pin=$row[pin]'>Transfer</a></td>";
