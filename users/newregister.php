        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="newregsucess.php" method="post">
                <div class="form-group row">
                  
                </div>
                <div class="form-group">
                  <input type="text" class="form-control " id="exampleInputsponcerid" name="sponcerid" value="<?php echo $data['userid'];?>" readonly/>
                </div>

                <div class="form-group">
                  <input type="text" class="form-control " id="exampleInputsponcerid" name="sponcer" value="<?php echo $data['name'];?>" readonly/>
                </div>
                ...
                <div class="form-group">
                  <input type="text" class="form-control " id="exampleInputname" name="pin" placeholder="e-Pin"required/>
                </div>
