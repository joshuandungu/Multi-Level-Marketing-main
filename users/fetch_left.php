...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Left Downline</h1>
...
<?php
    ...
    if ($left_side != '') {
        $name = mysqli_fetch_array(mysqli_query($db,"select * from user where userid = '$left_side'"));
           $k++;
        ?> <tr>
              <td><?php echo '1'; ?></td>

                <td><?php echo $left_side; ?></td>
