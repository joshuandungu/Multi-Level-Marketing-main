            ...
            <div class="row bg-warning">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="stock_mesuccess.php" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control" id="exampleInputuserid" aria-describedby="emailHelp"  name="userid" value="<?php echo $_SESSION[userid];?>"readonly/>
                    </div>
