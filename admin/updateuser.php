            ...
            <div class="p-5">
              ...
              <form class="user" action="" method="GET">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <input type="password" class="form-control form-control-user" id="exampleInputemail" name="password"  value="<?php
                  echo $_GET['password']?>">
                </div>
              ...
              <?php
                    ...
                    $query="UPDATE `user` SET userid='$userid',name='$name',email='$email',phone='$phone' ,password='$password' where userid='$userid'";
