                  ...
                  <div class="text-center">
                    ...
                    <?php
                     if(isset($_GET['msge']))?>  <h3 style="color:green; font-weight:bold;"><?php echo $_GET['msge'];?></h3>
                       <h2 class="h4 text-success"><?php echo "$msge";?></h2>
                      <h2 class="h4 text-danger"><?php echo "$msg";?></h2>
                    <h1 class="h4 text-gray-900 mb-4">Add item</h1>
                  </div>
                  <form class="user" action="add_itemsuccess.php" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control" id="exampleInputuserid" aria-describedby="emailHelp"  name="name" placeholder="Enter Name of item..."required/>
                    </div>
                    
                    
                    <div class="form-group">
                      <input type="number" class="form-control" id="exampleInputPassword"  name="dp" placeholder="DP"required/>
                    </div>
                    
                    <div class="form-group">
                      <input type="number" class="form-control" id="exampleInputPassword"  name="bv" placeholder="BV"required/>
                    </div>
