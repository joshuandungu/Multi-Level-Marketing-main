...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Pin(2000) Genrate</h1>
          ...
          <div class="col-lg-10">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Genrate Pin(2000)</h1>
              </div>
...
if (isset($_POST['done'])) {
    ...
    $sub_Admin = mysqli_num_rows(mysqli_query($db,"select * from subadmin where userid = '$sponcerid'"));
    if($row==1){
     $name = $search['name'];
...
?>
              ...
              <form class="user" method="post" action="">
                ...
                <button name="gen" class="btn btn-primary btn-user btn-block" >
                  Generate Pin
                </button>
                <hr>
