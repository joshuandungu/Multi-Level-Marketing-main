...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Advance E-Pin Genrate</h1>
          ...
          <div class="col-lg-10">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Genrate Advance E-Pin(1000)</h1>
              </div>
...
if (isset($_POST['done'])) {
    ...
    $search_subadmin = mysqli_fetch_array(mysqli_query($db,"select * from admin where userid = '$sponcerid'" ));
    $row = mysqli_num_rows(mysqli_query($db,"select * from user where userid = '$sponcerid'"));
    $sub_Admin = mysqli_num_rows(mysqli_query($db,"select * from admin where userid = '$sponcerid'"));
    if($row==1){
     $name = $search['name'];
...
?>
              ...
              <form class="user" method="post" action="">
                ...
                <div class="form-group">
                  <input type="pinno"  name="pinno" class="form-control form-control-user" placeholder="No. of E-Pin"required/>
                </div>
                ...
                <button name="generate" class="btn btn-primary btn-user btn-block" >
                  Generate Pin
                </button>
                <hr>
