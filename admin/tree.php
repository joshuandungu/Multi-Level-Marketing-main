 ...
 <!-- Custom fonts for this template-->
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">tree Page</h1>
        </div>
        ...
        <div class="text-center">
          ...
          <h1 class="h4 text-gray-900 mb-4">Tree View</h1><hr>
          </div>
           <div class="card-body">
          ...
          ?> 
            <div class="col-<?php echo 12/$divide ?>  p-1 text-center">
             ...
             <img src="<?php echo ($id[$d]!='')?"tr2.png":"tr.png" ?>" class="img-fluid" alt="" style="width:120px"><br>
